...
%  ALL that region's PCC values against a null mean of 0
...
% ======================================================================
%  group_ttest_str - one-sample t-test of a region's PCC values
...
%  ALL of that region's PCC values.
% ======================================================================
...
%  Each subplot's title also reports a one-sample t-test (vs. 0) over
%  ALL of that region's PCC values.
% ======================================================================
