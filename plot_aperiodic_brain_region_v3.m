...
%  in addition to the existing 'rewardsize' and 'choiceornochoice'.
%
...
%  t-tests, figure saving) runs for all four automatically.
%
...
%    predictor  = {'rewardsize', 'choiceornochoice', 'initialbar', 'playedtr'}
%  TWO figures:
...
predictors = {'rewardsize', 'choiceornochoice', 'initialbar', 'playedtr'};
